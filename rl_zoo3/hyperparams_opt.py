...
HYPERPARAMS_SAMPLER = {
    ...
    "ppo_mod_sampling_gae_t" : sample_ppo_params_with_kl_bound, 
    "ppo_mod_sampling_gae_tau" : sample_ppo_params_with_kl_bound, 
    "ppo_mod_loss" :    sample_ppo_params_with_kl_bound,
    "ppo_mod_loss_gae_tau" : sample_ppo_params_with_kl_bound,
...
HYPERPARAMS_CONVERTER = {
    ...
    "ppo_mod_sampling_gae_t" : convert_onpolicy_params, 
    "ppo_mod_sampling_gae_tau" : convert_onpolicy_params, 
    "ppo_mod_loss" :    convert_onpolicy_params,
    "ppo_mod_loss_gae_tau" : convert_onpolicy_params,
