...
class TimedRolloutBufferGaeT(TimedRolloutBuffer):
    """
    Rollout buffer that also saves time step of transitions during the rollout and uses a modified GAE calculation with fixed time estimator.
    ...
    def compute_returns_and_advantage(self, last_values: th.Tensor, dones: np.ndarray) -> None:
        """
        Uses fixed time Generalized Advantage Estimation to compute the advantage. 
...
class TimedRolloutBufferSamplingGaeT(TimedRolloutBufferSampling):
    """
    ...
    Furthermore, it uses a modified GAE calculation with fixed time estimator.
    :param buffer_size: Max number of element in the buffer
    :param observation_space: Observation space
    :param action_space: Action space
    :param device: PyTorch device
