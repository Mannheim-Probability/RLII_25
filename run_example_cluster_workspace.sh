...
export WAND_RUN_DIR="${WORKSPACE}/wandb"
...
for i in "${!seeds[@]}"; do
    ...
    for j in "${!envs[@]}"; do
        ...
        CUDA_VISIBLE_DEVICES=$gpu_id python train.py --algo $algo --env $env --hyperparams n_timesteps:1000 --eval-freq 25 --log-interval 25 --eval-episodes 2 --n-eval-envs 1 --seed $seed -f "${WORKSPACE}/logs/example_project/example_3" --verbose 1 --uuid --track --wandb-project-name "Cluster_testing" --wandb-entity "RL2_2025" -tags test_cluster_workspaces  &
